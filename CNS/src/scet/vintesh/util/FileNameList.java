...
public class FileNameList {
    ...
    public static final String folderName = "output/";
    public static final String inputFile = folderName + "inputFile.txt";
    public static final String caesarCipherE = folderName + "caesarCipherE.txt";
    public static final String caesarCipherD = folderName + "caesarCipherD.txt";
    public static final String monoAlphabaticCipherE = folderName + "monoAlphabaticCipherE.txt";
